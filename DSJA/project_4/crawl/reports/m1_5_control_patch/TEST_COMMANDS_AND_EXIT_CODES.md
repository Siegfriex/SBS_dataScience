...
|---|---|---:|---|---|
| Full unit/schema/negative suite | `P4_CRAWL_RAW_SOURCE_ROOT=<local-runtime-root> PYTHONPATH=crawl/src:. .venv/bin/python -m pytest crawl/tests crawl/control/tests -q -rs` | 0 | 64 passed, 0 skipped | runtime command log; `23b242da31c63687cc100af0603dacc7b4bafe2c` |
...
| Git whitespace validation | `git diff --check b64270bd4ab839ec750a4ceceb08d57957c88782...23b242da31c63687cc100af0603dacc7b4bafe2c` | 0 | PASS | Git object range |
